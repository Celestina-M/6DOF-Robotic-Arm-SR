...
import numpy as np
from src.robotic_arm_new import RoboticArm 
...
def test_ik_success_rate():
    ...
    for i in range(num_tests):
        ...
        # IK求解
        success, angles = arm.inverse_kinematics(target, method='jacobian')
        if success:
            success_count += 1
            # 验证精度
